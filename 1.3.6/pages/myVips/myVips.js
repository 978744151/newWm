    ...
    if (e.detail.errMsg == "getPhoneNumber:ok") {
      wx.login({
        success: function(res) {
          ...
          let url = app._host + '/index.php?ctrl=wxapp&action=getMemberCard&access_token=' + wx.getStorageSync('access_token') + '&iv=' + e.detail.iv + '&encryptedData=' + e.detail.encryptedData + '&id=' + app.shopId + "&code=" + code;
          wx.request({
            url: encodeURI(url),
            success: function(res) {
              if (!res.data.status) {
