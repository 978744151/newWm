...
Page({
    ...
    onLoad: function (event) {
        ...
        this.setData({access_token,dir,event,totalprice: event.totalprice});
    ...
    onShow: function (e) {
        ...
        API.IndexData(this, this.data.event, this.data.dir,function(that){
          ...
          var _cartData = wx.getStorageSync('cartTemp_zt') || {};
    ...
    selectOk: function () {
        ...
        console.log('isYYYYYYYYYYYYYYYYYYYY', skuAttr, skuAttrname)
        ...
        try {
            wx.setStorageSync('cartTemp_zt', goodsCart);
        ...
        wx.showModal({
            ...
            success: function (res) {
                if (res.confirm) {
                    ...
                    try {
                        wx.setStorageSync('cartTemp_zt', cartData);
    ...
    tapPay: function (e) {
      pickDishes.tapPay(this, 'createOrder_zt')
      return;
        ...
        if (this.data.cartData.totalPrice < 0 || !(this.data.cartData.foodsNum > 0)) {
            ...
            zynetwork.apiUrl('activity/getValidVouchersByPayMoney', { pay_money: totalPrice }, (res) => {
                ...
                wx.navigateTo({ url: '/pages/createOrder_zt/index?youhui=' + youhui + '&reduction_id=' + reduction_id + '&skuids=' + skuids + '&hasReduction=' + hasReduction})
            });
        }
    ...
    anewCart: function () { //再来一单重新添加本地缓存
      ...
      this.setData({
        ...
        wx.setStorageSync('cartTemp_zt', _cartTemp);
    },
    ...
    cartAdd: function (e) {
      ...
      app.globalData.lastTapTime = time;
        ...
        wx.setStorageSync('cartTemp_zt', this.data.cartData);
        wx.setStorageSync('goodsType', goodsType);
