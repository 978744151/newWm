...
Page({
    ...
    getOrderList:function(){
      ...
      wx.request({
        ...
        method: 'GET',
        dataType: 'json',
        data: { id: app.shopId, page: '1', access_token, otype: otype },
    ...
    onLoad: function(options) {
      ...
      var fcolor = "#000000"
      if (ocolor != "#ffffff") {fcolor = '#ffffff'}
    ...
    refreshList: function(e) {
        ...
        wx.request({
            ...
            method: 'GET',
            dataType: 'json',
            data: { id: app.shopId, page: '1', access_token:access_token, otype:otype},
            success: function(res) {
                var data = res.data.data;
                that.setData({
                    orderList: data,
    ...
    nowPay: function(e) {
        ...
        wx.request({
            ...
            method: 'POST',
            dataType: 'json',
            data: { orderid: orderid ,payFrom: e.detail.payMethod === 'balance'?'balance':'weChat'},
            success: function(res) {
                wx.hideLoading();
                if (res.statusCode != 200) {
